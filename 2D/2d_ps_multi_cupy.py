...
from hamiltonian import  KE, KE_FFT, KE_Borisov, Gamma_etf_erf,inverse_weyl_transform, unvec_inverse_weyl_transform
...
if __name__ == '__main__':
    ...
    t_HPS_begin=perf_counter()
    HPS = inverse_weyl_transform(EPS, H.shape[0], H.R, H.P)
    t_HPS_end=perf_counter()
    print("inverse_weyl_transform ", t_HPS_end - t_HPS_begin)

    t_HPS_begin=perf_counter()
    HPS_unvec = unvec_inverse_weyl_transform(EPS, H.shape[0], H.R, H.P)
    t_HPS_end=perf_counter()
    print("unvec_inverse_weyl_transform ", t_HPS_end - t_HPS_begin)
     
    print("norm of HPS-HPSunvec",xp.linalg.norm(HPS-HPS_unvec))
